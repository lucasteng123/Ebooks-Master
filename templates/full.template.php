...
<body id="body" onload="do_onload_things();">
					...
					<div class="col slideout-box-col no-spacing col-sm-6 col-xs-12">
						<div id="slideout-box" class="slideout-box">
									...
									<div class="form-group" style="padding:0;margin:0;">
										...
										<div class="col-md-9">
											...
											<div class="success-message">
												Your book was uploaded!<br />
												Redirecting you to book in <span class="timer" data-time="3">3</span> seconds.
											</div>
										</div>
									</div>
							...
							<div class="container-fluid slideout-page" data-name="account">
								...
								<h2><?php echo $user_name; ?>'s Account</h2>
								...
								<div class="success-message">
									Logged out!<br />
									Reloading the page in <span class="timer" data-time="3">3</span> seconds.
								</div>
						...
						<div class="col no-spacing col-sm-3 col-xs-12">
							<a href="<?php echo WEB_PATH; ?>">
								<div class="logo" data-tab-type="homepage">
									<img
									src="<?php echo WEB_PATH.'/res/img/bestelogo_white.png'; ?>"
									title="best ebooks - BestEbooks.ca Logo"
									/>
			...
			<div class="row row-offcanvas row-offcanvas-left">
				<div class="col-md-2 col-sm-3 col-xs-6 no-spacing sidebar-offcanvas" id="sidebar">
					...
					<div class="category-container blue">
						<div class="category">
							<a href="<?php echo WEB_PATH; ?>?location=admin"><div class="title" data-tab-type="category" data-id="1">Admin Controls
						<div class="spacer"></div></div></a>
							<!--<div class="subcats">
							...
							<div class="item subcats">
								...
								?>
									<div class="item subcat ajax-tab" data-tab-type="subcategory" data-catid="<?php echo $baseid ?>" data-id="<?php echo $sid ?>">
										<div class="title"><span class="glyphicon glyphicon-chevron-right"></span> <?php echo $sname ?></div>
									</div>
								<?php } ?>
							</div>
						</div>
	...
	<div id="SITE_FOOTER" class="container-fluid">
		<div class="container">
			...
			<span class="footer-item"><?php echo $ss->get_value('copytext'); ?></span>
